...
TEXTS = {
    "ru": {
        ...
        "end_user_m": "Ты прошел симуляцию. Полный результат отправлен руководству.",
    ...
    "kz": {
        ...
        "end_user_m": "Сен симуляциядан оттiң. Толық натижең тексерушiге жiберiлдi.",
        "end_user_f": "Сен симуляциядан оттiң. Толық натижең тексерушiге жiберiлдi.",
...
# [ВСТАВЛЯЙ СВОЙ ОСТАЛЬНОЙ КОД БОТА СЮДА]


# ============================================================
# ИНТЕГРАЦИЯ ЛЕНДИНГА (FastAPI)
# ============================================================
...
async def bot_webhook(request: Request):
    # Этот эндпоинт будет принимать запросы от Телеграма
